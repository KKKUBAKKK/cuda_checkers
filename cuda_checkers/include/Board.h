...
#define MAX_GAMES_CPU 1
#define MAX_GAMES_GPU 1000
...
public:
    ...
    __host__ float simulate_n_games_cpu(std::mt19937& rng, Move *moves, Move *stack, bool is_player_white, int n = MAX_GAMES_CPU, float time_limit_ms = TIME_LIMIT_MS);
